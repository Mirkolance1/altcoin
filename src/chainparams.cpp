...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1559236759, 2083598615, 0x1e0ffff0, 1, 1000000001 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x764d3bc66e835dbbd5d39506c1f627b72adef0c495d28836d79fadc5ed38ca04"));
        assert(genesis.hashMerkleRoot == uint256S("0x48a4d3c34a87fcc4607d7d6e1cea686179bf85f0dd9adba98d43ec72e2ba4be8"));
        ...
        //vSeeds.emplace_back("seed-a.altcoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.altcointools.com");
        //vSeeds.emplace_back("dnsseed.altcoinpool.org");
        ...
        checkpointData = {
            {
                {  0, uint256S("0x764d3bc66e835dbbd5d39506c1f627b72adef0c495d28836d79fadc5ed38ca04")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("localhost:19999");
        vSeeds.emplace_back("localhost:20000");
        //vSeeds.emplace_back("testnet-seed.altcointools.com");
        //vSeeds.emplace_back("seed-b.altcoin.loshan.co.uk");
