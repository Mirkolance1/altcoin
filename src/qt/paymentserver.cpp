...
const char* BIP71_MIMETYPE_PAYMENT = "application/altcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/altcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/altcoin-paymentrequest";
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("altcoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'altcoin://' is not a valid URI. Use 'altcoin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Altcoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
