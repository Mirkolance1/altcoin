...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " altcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  altcoin-tx [options] <hex-tx> [commands]  Update hex-encoded altcoin transaction\n" +
            "or:     altcoin-tx [options] -create [commands]   Create hex-encoded altcoin transaction\n" +
            "\n";
