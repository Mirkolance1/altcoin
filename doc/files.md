...
* altcoin.conf: contains configuration settings for altcoind or altcoin-qt
* altcoind.pid: stores the process id of altcoind while running
...
* debug.log: contains debug information and general logging generated by altcoind or altcoin-qt
