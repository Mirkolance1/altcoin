Altcoin Core version *0.15.1* is now available from:

  <https://download.altcoin.org/altcoin-0.15.1/>
...
A number of changes to the way Altcoin Core deals with peer connections and invalid blocks
