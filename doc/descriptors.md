# Support for Output Descriptors in Altcoin Core

Since Altcoin Core v0.17, there is support for Output Descriptors in the
...
on Altcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Altcoin Core wallets, a convenience function `combo` is
