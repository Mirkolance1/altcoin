...
"""Verify that starting altcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start altcoin with -h for help text")
        ...
        self.log.info("Start altcoin with -version for version information")
        ...
        self.log.info("Start altcoind with -fakearg to make sure it does not start")
